...
- Implemented via `data-bs-theme` attribute on `<html>` + CSS custom properties
...
- Mobile-first using Bootstrap 5 grid + custom CSS
...
- Brief Professional identity and experience
